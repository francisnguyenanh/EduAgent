...
`python`, `fastapi`, `google-adk`, `gemini-api`, `vertex-ai`, `google-cloud-run`, `google-cloud-firestore`, `google-cloud-pubsub`, `google-cloud-trace`, `google-secret-manager`, `opentelemetry`, `gmail-api`, `google-sheets-api`, `pytest`, `tenacity`, `docker`, `markdown`, `json-schema`, `rest-api`, `event-driven`, `ocr`, `socratic-method`, `education-technology`, `collaborative-agent`, `zero-trust`, `data-mutation`.
