...
| **Độ Tin Cậy & Eval** | Đánh giá chủ quan qua LLM-as-judge | **4-Layer Deterministic ADK Eval Suite (50/50 cases)**: Kiểm thử tất định đa tầng (An ninh, Hành vi, Trí nhớ, Bước nhảy nhận thức). |
